...
| 8 | Native display | The legacy framebuffer is retired. Installed r147 owns panel/DSI/DSC/OVL state but stalls after OVL2 with DSC input `1x1`. Prepared r148 completes the vendor DSC selectors and OVL relay in cold-start/DPMS order. | Pass CI and clean-flash paired r148 images. Require clean OVL0/1/2 flow, DSC completion, advancing DSI counters, clean KMS pixels, stable USB, 60/120 Hz modes, brightness, blank/unblank, sustained touch, suspend/resume and repeated boots. |
