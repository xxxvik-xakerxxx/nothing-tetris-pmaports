...
| Prepared GNSS source candidate | Current `codex/next-hardware` worktree | Kernel `pkgrel=128` and device `8-r5` package only stock-derived Tetris GNSS v051 as a manual service. It must pass CI and a clean boot before promotion. |
