...
| 8 | Native display | The legacy framebuffer is retired from the shipped DTB. Clean r145 owns the route but not a valid frame. r147 combines the confirmed remaining B4.1/LK differences across panel packet transport, DSC version/SPR, N4 D-PHY, DSI timing/TXRX/PSCTRL/HSTX/FIFO and OVL cold-start ordering. | Pass CI and clean-flash paired r147 images. Require clean OVL0/1/2 flow, DSC completion, advancing DSI counters, clean KMS pixels, stable USB, 60/120 Hz modes, brightness, blank/unblank, sustained touch, suspend/resume and repeated boots. |
