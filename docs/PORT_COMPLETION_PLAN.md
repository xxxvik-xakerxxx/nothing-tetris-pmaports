...
| 8 | Native display | The legacy framebuffer is retired from the shipped DTB. Clean r145 owns the full OVL route, shadow bypass and `DSC_MODE=0x10001`, but still reports abnormal EOF without frame completion. Direct NothingOS review found the remaining unowned DSC 1.1 version field at `DSC+0x200[6:5]`; r146 programs only this field. | Pass CI and clean-flash paired r146 images. Require clean OVL0/1/2 flow, DSC completion, advancing DSI counters, clean KMS pixels, stable USB, 60/120 Hz modes, brightness, blank/unblank, sustained touch, suspend/resume and repeated boots. |
