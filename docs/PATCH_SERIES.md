...
The kernel package currently uses `pkgver=6.18` and `pkgrel=70`.
...
r50-r70 packages installed; that would make future packages look like
...
The r70 package also stages Android MT6878 connectivity modules from the Nothing
...
2. Validate r70 MT6631 vendor module loading on device: conninfra, WMT, Wi-Fi
   and Bluetooth.
