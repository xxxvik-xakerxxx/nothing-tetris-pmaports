...
The kernel package currently uses `pkgver=6.18` and `pkgrel=75`.
...
r50-r75 packages installed; that would make future packages look like
...
The r75 package also stages Android MT6878 connectivity modules from the Nothing
...
2. Validate r75 MT6631 vendor module loading on device: conninfra, WMT, Wi-Fi
   and Bluetooth.
