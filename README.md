...
| Display | Native DSI/panel | Untested | Packaged r133 includes MMSYS clocks/routing, DISP/MM power, OVL, DSC, DSI host, MIPI PHY, bounded larb0/IOMMU DMA and the Samsung panel. Its only FIT DTB removes simplefb, and the kernel excludes simpledrm/sysfb. All 17 patches strict-apply and touched objects/native DTB passed targeted LLVM 21 builds; device evidence is still required. |
